...
public class ColorProfile {
	...
	public static final String colorcf = "colorcfcf";
	public static final String colorc9 = "colorc9";
	public static final String colorbf = "colorbf";
	public static final String color8a = "color8a";
	public static final String color29 = "color29";
	public static final String color59 = "color59";
	...
	private ColorProfile(String name) {
		...
		if (NIGHT.equals(name)) {
			...
			HighlightingBackgroundOption = createOption(name, "Highlighting", 255, 192, 128);
			HighlightingForegroundOption = createNullOption(name, "HighlightingForeground");
			RegularTextOption = createOption(name, "Text", 58, 52, 43);
			HyperlinkTextOption = createOption(name, "Hyperlink", 60, 139, 255);
			VisitedHyperlinkTextOption = createOption(name, "VisitedHyperlink", 200, 139, 255);
			FooterFillOption = createOption(name, "FooterFillOption", 170, 170, 170);
			FooterNGBackgroundOption = createOption(name, "FooterNGBackgroundOption", 68, 68, 68);
			FooterNGForegroundOption = createOption(name, "FooterNGForegroundOption", 187, 187, 187);
			FooterNGForegroundUnreadOption = createOption(name, "FooterNGForegroundUnreadOption", 119, 119, 119);
		} else if (colorc9.equals(name)) {
			WallpaperOption = new ZLStringOption("Colors", name + ":Wallpaper", "");
			FillModeOption = new ZLEnumOption<ZLPaintContext.FillMode>("Colors", name + ":FillMode",
					ZLPaintContext.FillMode.tile);
			BackgroundOption = createOption(name, "Background", 197, 186, 173);
			SelectionBackgroundOption = createOption(name, "SelectionBackground", 82, 131, 194);
			SelectionForegroundOption = createNullOption(name, "SelectionForeground");
			HighlightingBackgroundOption = createOption(name, "Highlighting", 255, 192, 128);
			HighlightingForegroundOption = createNullOption(name, "HighlightingForeground");
			...
			FooterNGForegroundOption = createOption(name, "FooterNGForegroundOption", 187, 187, 187);
			FooterNGForegroundUnreadOption = createOption(name, "FooterNGForegroundUnreadOption", 119, 119, 119);
		} else if (colorbf.equals(name)) {
			WallpaperOption = new ZLStringOption("Colors", name + ":Wallpaper", "wallpapers/paper.jpg");
			FillModeOption = new ZLEnumOption<ZLPaintContext.FillMode>("Colors", name + ":FillMode",
					ZLPaintContext.FillMode.tile);
			BackgroundOption = createOption(name, "Background", 213, 198, 167);
			SelectionBackgroundOption = createOption(name, "SelectionBackground", 82, 131, 194);
			SelectionForegroundOption = createNullOption(name, "SelectionForeground");
			HighlightingBackgroundOption = createOption(name, "Highlighting", 255, 192, 128);
			HighlightingForegroundOption = createNullOption(name, "HighlightingForeground");
			...
			FooterNGForegroundOption = createOption(name, "FooterNGForegroundOption", 187, 187, 187);
			FooterNGForegroundUnreadOption = createOption(name, "FooterNGForegroundUnreadOption", 119, 119, 119);
		} else if (color8a.equals(name)) {
			WallpaperOption = new ZLStringOption("Colors", name + ":Wallpaper", "");
			FillModeOption = new ZLEnumOption<ZLPaintContext.FillMode>("Colors", name + ":FillMode",
					ZLPaintContext.FillMode.tile);
			BackgroundOption = createOption(name, "Background", 206, 235, 206);
			SelectionBackgroundOption = createOption(name, "SelectionBackground", 82, 131, 194);
			SelectionForegroundOption = createNullOption(name, "SelectionForeground");
			HighlightingBackgroundOption = createOption(name, "Highlighting", 255, 192, 128);
			HighlightingForegroundOption = createNullOption(name, "HighlightingForeground");
			RegularTextOption = createOption(name, "Text", 51, 51, 51);
			HyperlinkTextOption = createOption(name, "Hyperlink", 60, 139, 255);
			VisitedHyperlinkTextOption = createOption(name, "VisitedHyperlink", 200, 139, 255);
			FooterFillOption = createOption(name, "FooterFillOption", 170, 170, 170);
			FooterNGBackgroundOption = createOption(name, "FooterNGBackgroundOption", 68, 68, 68);
			FooterNGForegroundOption = createOption(name, "FooterNGForegroundOption", 187, 187, 187);
			FooterNGForegroundUnreadOption = createOption(name, "FooterNGForegroundUnreadOption", 119, 119, 119);
		} else if (color29.equals(name)) {
			WallpaperOption = new ZLStringOption("Colors", name + ":Wallpaper", "");
			FillModeOption = new ZLEnumOption<ZLPaintContext.FillMode>("Colors", name + ":FillMode",
					ZLPaintContext.FillMode.tile);
			//背景颜色
			BackgroundOption = createOption(name, "Background", 2, 67, 98);
			//选中背景颜色
			SelectionBackgroundOption = createOption(name, "SelectionBackground", 82, 131, 194);
			SelectionForegroundOption = createNullOption(name, "SelectionForeground");
			HighlightingBackgroundOption = createOption(name, "Highlighting", 255, 192, 128);
			HighlightingForegroundOption = createNullOption(name, "HighlightingForeground");
			RegularTextOption = createOption(name, "Text", 255, 255, 255);
			HyperlinkTextOption = createOption(name, "Hyperlink", 60, 139, 226);
			VisitedHyperlinkTextOption = createOption(name, "VisitedHyperlink", 200, 139, 255);
			FooterFillOption = createOption(name, "FooterFillOption", 170, 170, 170);
			FooterNGBackgroundOption = createOption(name, "FooterNGBackgroundOption", 68, 68, 68);
			FooterNGForegroundOption = createOption(name, "FooterNGForegroundOption", 187, 187, 187);
			FooterNGForegroundUnreadOption = createOption(name, "FooterNGForegroundUnreadOption", 119, 119, 119);
		} else if (color59.equals(name)) {
			WallpaperOption = new ZLStringOption("Colors", name + ":Wallpaper", "");
			FillModeOption = new ZLEnumOption<ZLPaintContext.FillMode>("Colors", name + ":FillMode",
					ZLPaintContext.FillMode.tile);
			BackgroundOption = createOption(name, "Background", 58, 49, 49);
			SelectionBackgroundOption = createOption(name, "SelectionBackground", 82, 131, 194);
			SelectionForegroundOption = createNullOption(name, "SelectionForeground");
			HighlightingBackgroundOption = createOption(name, "Highlighting", 255, 192, 128);
			HighlightingForegroundOption = createNullOption(name, "HighlightingForeground");
